...
export const AddUserButton = () => {
  ...
  return (
      <div>
        <button onClick={handleClick} className='p-2 text-2xl w-36 flex justify-center mt-4 text-primary border border-primary items-center hover:text-base-100 hover:bg-primary transition-all rounded-lg flex-col hover:shadow-[5px_5px_0_0_rgba(106,165,23,0.12)]'><AiOutlineUserAdd /><p className="text-sm py-1">Ajouter</p></button>
